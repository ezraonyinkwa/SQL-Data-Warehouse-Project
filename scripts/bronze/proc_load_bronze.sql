...
SET @batch_start_time = GETDATE();
	...
	TRUNCATE TABLE bronze.crm_cust_info --- Delete any data in the table

	PRINT'>> Inserting Data Into:bronze.crm_cust_info';
	BULK INSERT bronze.crm_cust_info --- Load & Insert (Full Load)
...
PRINT'===================================';---- Calculates total time for loading the brone layer
